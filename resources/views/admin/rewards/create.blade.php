<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-white">➕ Tambah Reward</h2>
    </x-slot>

    <div class="py-8 px-4 bg-[#0f172a] min-h-screen text-white max-w-2xl mx-auto">
        <form action="{{ route('rewards.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full bg-gray-800 border border-gray-700 rounded px-4 py-2 mt-1"></textarea>
            </div>
